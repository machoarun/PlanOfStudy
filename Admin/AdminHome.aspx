<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="POS_Code.Home"
    MasterPageFile="~/Admin/POS.Master" Title="Plan of Study Details" %>
    ...
    <div>
        <table id="POSTable" border="0" cellpadding="0" cellspacing="0" align="center" width="800px">
            <tr>
                <td align="center">
                    <div id="Label">
                        <asp:Label ID="lblPersonal" runat="server" Text="Graduate Plan of Study (POS)"
