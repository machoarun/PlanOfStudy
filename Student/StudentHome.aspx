<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentHome.aspx.cs" Inherits="POS_Code.StudentHome"
    MasterPageFile="~/Student/Student.Master" Title="Plan of Study Details" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table id="POSTable" border="0" cellpadding="0" cellspacing="0" width="800px">
            <tr>
                <td align="center">
                    <div id="Label">
                        <asp:Label ID="lblStudent" runat="server" Text="Graduate Plan of Study (POS)"
